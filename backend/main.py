...
from .models import Parsons, Student, TaskAttempt, TaskList, TaskListItem, TaskListViewer, Teacher, RegistrationToken, ModelAnswer
...
@app.get("/api/admin/statistics/user-activity", response_model=UserActivityResponse)
async def get_user_activity_statistics(
    ...
    from .models import Student, Teacher, TaskAttempt
