import { loadUsername, formatDate, showError } from './utils.js';
...
function loadTaskLists() {
    fetch('/api/all-problemsets', { credentials: 'include' })
      ...
      .catch(err => {
        ...
        showError(err.message || 'An unexpected error occurred. You might not have permission to view this page.', 'task-lists-container');
      });
}